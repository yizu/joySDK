...
function sign(&$params) {
    ...
    // 签名证书路径
    $cert_path = APPPATH . 'third_party/yinlianpay/certs/PM_700000000000002_acp.pfx';
...
function getPulbicKeyByCertId($certId) {
    // 证书目录
    $cert_dir = APPPATH . 'third_party/yinlianpay/certs';
...
function getCertId($cert_path) {
    ...
    openssl_pkcs12_read($pkcs12certdata, $certs, '100200');
    $x509data = $certs ['cert'];
...
function getSignCertId() {
    ...
    return getCertId(APPPATH . 'third_party/yinlianpay/certs/PM_700000000000002_acp.pfx');
}
...
function getPrivateKey($cert_path) {
    ...
    openssl_pkcs12_read($pkcs12, $certs, '100200');
    return $certs ['pkey'];
}
